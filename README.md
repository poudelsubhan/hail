...
| **Participating** (you got an invite) | [agent-concord-starter template](https://github.com/poudelsubhan/agent-concord-starter) → click **Use this template**, then [docs/participant-quickstart.md](docs/participant-quickstart.md) for context |
